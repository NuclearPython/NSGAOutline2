...
# Embedded file name: C:\Users\depila\Desktop\Graduate Research\GeneticAlgorithims\CreateNSGA2\NSGAOutline\Gnowee_multi.py
# Compiled at: 2021-03-19 03:50:35
"""!
@file src/Gnowee.py
@package Gnowee
...
def main(gh):
    ...
    for p in range(0, initNum, 1):
        pop.append(Parent(fitness=1e+99, variables=initParams[p]))

    pop, changes, timeline = gh.population_update(pop, [ p.variables for p in pop ], timeline=timeline)
    ...
    while converge == False:
        ...
        pop, changes, timeline = gh.population_update(pop, children, timeline=timeline, adoptedParents=ind, mhFrac=0.2, randomParents=True)
